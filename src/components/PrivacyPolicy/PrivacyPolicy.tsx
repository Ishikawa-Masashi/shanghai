        ...
        <div className="main">
          <div className={styles.article}>
            <div id="placeholders">
              ...
              <p>
                {author} built the {app} app as a Free app. This SERVICE is
                provided by {author} at no cost and is intended for use as is.
              </p>
              <p>
              ...
              <p>
                ...
                Policy, do not hesitate to contact me. This privacy policy page
                was created at{' '}
              </p>
